...
import UseInformation from "../../Hooks/Information/useInformation";
import useQuery from "../../Utils/QueryParams";
import { CarouselInformations } from "./style";

const Information = () => {
  const { informationUpload, getDataInformationUpload } = UseInformation();
  ...
  const getDataInformation = async () => {
    ...
    const response = await getDataInformationUpload(params);
  ...
  // let vidList = informationUpload[0]?.video?.map((item) => {
