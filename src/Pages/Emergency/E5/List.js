...
import TableEmergencyV2 from '../CustomTable/TableEmergencyV2';
...
function List() {
	...
	// context
	const { listEmergency5, getEmergency5 } = useContext(EmergencyContext);
	...
	const handleDeleteData = async () => {
		const respon = await ApiOperational.deleteEmergency5(dataRow._id);
		if (respon) {
			...
			<Dialog open={dialogPrint} fullScreen>
				<Container maxWidth="xl">
					...
					<div ref={componentRef}>
						<Box sx={{ p: 3 }}>
							<HeaderPrintV2
								title1="Emergency Form E.5"
								title2="Peristiwa Luar Biasa Hebat / Accident"
								number="LRTJ-FR-POP-007-e"
								revisi="01"
								page="Page 3 of 3"
							/>
