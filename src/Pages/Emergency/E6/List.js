...
function List() {
	...
	// context
	const { listEmergency6, getEmergency6 } = useContext(EmergencyContext);
	...
	const handleDeleteData = async () => {
		const respon = await ApiOperational.deleteEmergency6(dataRow._id);
		if (respon) {
			...
			<Dialog open={dialogPrint} fullScreen>
				<Container maxWidth="xl">
					...
					<div ref={componentRef}>
						<Box sx={{ p: 3 }}>
							<HeaderPrintV2
								title1="Emergency Form E.6"
								title2="Permintaan Dan Pemberian"
								title3="Kereta Api Penolong"
								number="LRTJ-FR-POP-007-f"
								revisi="01"
								page="Page 3 of 3"
							/>
