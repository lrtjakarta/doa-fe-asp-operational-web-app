...
import TableEmergencyV3 from '../CustomTable/TableEmergencyV3';
...
function List() {
	...
	// context
	const { listEmergency8, getEmergency8 } = useContext(EmergencyContext);
	...
	const handleDeleteData = async () => {
		const respon = await ApiOperational.deleteEmergency8(dataRow._id);
		if (respon) {
			...
			<Dialog open={dialogPrint} fullScreen>
				<Container maxWidth="xl">
					...
					<div ref={componentRef}>
						<Box sx={{ p: 3 }}>
							<HeaderPrintV2
								title1="Emergency Form E.8"
								title2="Otoritas Raset Penghitung Gandar"
								number="LRTJ-FR-POP-007-h"
								revisi="01"
								page="Page 3 of 3"
							/>
