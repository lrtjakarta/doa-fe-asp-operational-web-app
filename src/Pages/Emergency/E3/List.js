...
function List() {
	...
	// context
	const { listEmergency3, getEmergency3 } = useContext(EmergencyContext);
	...
	const handleDeleteData = async () => {
		const respon = await ApiOperational.deleteEmergency3(dataRow._id);
		if (respon) {
			...
			<Dialog open={dialogPrint} fullScreen>
				<Container maxWidth="xl">
					...
					<div ref={componentRef}>
						<Box sx={{ p: 3 }}>
							<HeaderPrintV2
								title1="Emergency Form E.3"
								title2="Perintah Berjalan Melalui Jalur Kiri"
								number="LRTJ-FR-POP-007-c"
								revisi="01"
								page="Page 3 of 3"
							/>
