...
export default function HandOverJourney({id, workorderId, handleClose, TrainFinishClick, ...props}) {
    ...
    const loadData = async()=>{
        ...
        let dataresponse = await getDailyWorkById(id)
        let dataresponseLocal = await getDailyWorkByIdLocal(workorderId)
